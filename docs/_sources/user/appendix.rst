...
Overview
--------
If you are using Ubuntu (version 12/14) you can download  and run `cpac_install.sh <https://github.com/FCP-INDI/C-PAC/blob/v1.5.0/cpac_install.sh?raw=true>`__ with the following terminal commands as root:

.. code-block:: console

    wget https://github.com/FCP-INDI/C-PAC/blob/v1.5.0/cpac_install.sh?raw=true
