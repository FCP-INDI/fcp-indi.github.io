...
The benchmark package can be downloaded `here <https://s3.amazonaws.com/fcp-indi/resources/benchmark_package.tar.gz>`_.  The following instructions will guide you through the process of running the C-PAC benchmark.
