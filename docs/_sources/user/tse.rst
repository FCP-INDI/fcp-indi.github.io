...
#. **Connectivity Matrix:** A connectivity matrix can be generated via nilearn :cite:`cite-Abra14,cite-nile21,cite-nile21a`, ndmg :cite:`cite-Kiar17,cite-Neur18` or AFNI for the ``Avg`` timeseries output.
