...
Future updates will include a graphical user interface for C-PAC configuration, advanced analytic features (e.g., support vector machines, cluster analysis) and diffusion tensor imaging (DTI) capabilities.
...
.. line-block::
   **Primary Development Team:**
   ...
   Daniel Lurie (User Support, Documentation)
